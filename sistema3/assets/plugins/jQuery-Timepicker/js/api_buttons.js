function sellfy_init_buttons() {
    var sellfy_iframe_wrap = document.createElement('div');
    var sellfy_iframe = document.createElement('iframe');
    ...
    function sellfy_setDocumentOverflow(value){
    ...
    function sellfy_close_frame() {
        if(document.body.contains(sellfy_iframe_wrap)){
            document.body.removeChild(sellfy_iframe_wrap);
        }
        sellfy_setDocumentOverflow();
    }
    ...
    function sellfy_show_iframe(e) {
        ...
        sellfy_iframe.setAttribute('src', href + '/iframe/');
        sellfy_iframe.style.width = '100%';
        sellfy_iframe.style.height = '100%';
        sellfy_iframe.style.display = 'block';
        ...
        sellfy_iframe_wrap.style.width = '100%';
        sellfy_iframe_wrap.style.height = '100%';
        sellfy_iframe_wrap.style.top = '0';
        sellfy_iframe_wrap.style.bottom = '0';
        sellfy_iframe_wrap.style.left = '0';
        sellfy_iframe_wrap.style.right = '0';
        sellfy_iframe_wrap.style.position = 'fixed';
        sellfy_iframe_wrap.style.overflow = 'auto';
        sellfy_iframe_wrap.style.zIndex = '9999';
        sellfy_iframe_wrap.style.WebkitOverflowScrolling = 'touch';
        document.body.appendChild(sellfy_iframe_wrap);
        sellfy_iframe_wrap.appendChild(sellfy_iframe);
        sellfy_setDocumentOverflow('hidden');
        return false;
    }
    ...
    for (i = 0; i < allHTMLTags.length; i++) {
        ...
        if (classes[0] === 'sellfy-buy-button') {
            var activated = allHTMLTags[i].className.toString().indexOf('slfy_activated') !== -1 ? true : false;
            if (!activated) {
